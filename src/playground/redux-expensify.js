...
const expenseOne = store.dispatch(addExpense({description: 'REnt a cab', amount: 150, createdAt:-1000}));
...
const demoState = {
  expenses : [{
    id:'eueyriu',
    description:'Rent',
    note:'THis is the final payment for house',
    amount: 1500 ,
    createdAt: 0
  }],
  filters: {
